...
# annealing schedules
SCHEDULE_TYPE_INVERSE_SIGMOID = "inverse_sigmoid"
SCHEDULE_TYPE_EXPONENTIAL = "exponential"
SCHEDULE_TYPE_LINEAR = "linear"
ANNEALING_SCHEDULE_TYPES = [SCHEDULE_TYPE_INVERSE_SIGMOID, SCHEDULE_TYPE_EXPONENTIAL, SCHEDULE_TYPE_LINEAR]

VOCAB_WEIGHT_NAME = "vocab_weight_bias"
...
# alignment types
SOFT_ALIGNMENT = 'soft-alignment'
HARD_ALIGNMENT = 'hard-alignment'
...
ST_SOFTMAX_NAME = "st-softmax"
GUMBEL_SOFTMAX_NAME = "gumbel-softmax"
ST_GUMBEL_SOFTMAX_NAME = "st-gumbel-softmax"
INSTANTIATING_HIDDEN_CHOICES = [SOFTMAX_NAME, ST_SOFTMAX_NAME, GUMBEL_SOFTMAX_NAME, ST_GUMBEL_SOFTMAX_NAME]